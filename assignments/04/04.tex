...
\end{align}
%
% Dette er ikke nok. Vi er nødt til at vise hvordan kædereaktionen kører hvis 
%den gør det, og hvordan det her +1 har en effekt på vores talsystem.
%
% Forslag
%
% Lad a_i c^k + 1 være en møntsum plus en, af et sæt mønter, hvor a_i er et 
%heltal mindre end c som angiver antallet af mønter. \\ da 1 = c^0 kan vi 
%skrive \sum a_{1}+1 c^0 + yada yada. Hvis a_1 < c-1 tilføjes bare en mønt 
%af størrelse c^0. Hvis a_1 = c-1 får vi (c-1+1)c^0 = c^1. Dette starter nu
%potentielt en kaskadeeffekt som fordeler sig ned igennem møntrækken. Dermed
%kan alle beløb laves ved at "veksle" mindre mønter, når summan af dem giver
%den næste mønt i møntrækken.
%
